...
$evaluation = $_GET['evaluation'];
 ...
 $mysqli = new mysqli("localhost",'root','123456','infodb') or die('连接数据库失败');
    ...
    if($Tno){
        // echo "yes";
    $sql = "UPDATE evaluationinfo SET Sno=$Sno, Tno=$Tno,moralScore=$moralScore,theoryScore=$theoryScore,healthScore=$healthScore,practiceScore=$practiceScore,integrateScore=$integrateScore,evaluation='$evaluation' WHERE Sno=$Sno";
        //执行sql
