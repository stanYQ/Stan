    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改测评</span>
            </div>
                    ...
                    <form class="form-horizontal" role="form" action="./action/editEvaluationAction.php" method="get">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">思想道德素质分</label>
                             <div class="col-sm-6">
                              <?php
                            echo "<input class='form-control' id='moralScore' placeholder='$list[3]' name='moralScore' value='$list[3]' required='' type='text'>";
                            ?>
                          ...
                          <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">专业理论素质分</label>
                             <div class="col-sm-6">
                              <?php
                            echo "<input class='form-control' id='theoryScore' placeholder='$list[4]' name='theoryScore' value='$list[4]' required='' type='text'>";
                            ?>
                          ...
                          <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">身体素质分</label>
                             <div class="col-sm-6">
                               <?php
                            echo "<input class='form-control' id='healthScore' placeholder='$list[5]' name='healthScore' value='$list[5]' required='' type='text'>";
                            ?>
                          ...
                          <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">人文素质分</label>
                             <div class="col-sm-6">
                                <?php
                            echo "<input class='form-control' id='practiceScore' placeholder='$list[6]' name='practiceScore' value='$list[6]' required='' type='text'>";
                            ?>
                          ...
                          <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">创新与实践素质分</label>
                             <div class="col-sm-6">
                              <?php
                            echo "<input class='form-control' id='inregrateScore' placeholder='$list[7]' name='integrateScore' value='$list[7]' required='' type='text'>";
                            ?>
                            </div>
                            <p class="help-block col-sm-4 red">分（满分100分）</p>
                        </div>  
                            ...
                            <label class="col-sm-2 control-label no-padding-right">对该生评价</label>
                             <div class="col-sm-6">
                                <?php
                            echo "<textarea  class='form-control' id='evaluation' placeholder='$list[8]' name='evaluation' value='$list[8]' cols='40'   rows='4'   style='OVERFLOW:hidden'></textarea>";
                            ?>
                            </div>
